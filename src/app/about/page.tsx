            ...
            <div className="container mx-auto grid md:grid-cols-2 gap-12 items-center px-4">
              <div>
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>Founded in a small workshop with a big dream, Bridge Ltd began its journey with a simple mission: to bridge the gap between brands and their customers through tangible, high-quality products. We saw a universe of possibilities in items that people use every day.</p>
                  <p>Over the years, we've expanded our horizons, moving from simple pens to a diverse constellation of products including high-tech USB drives and elegant gift boxes. Our commitment to quality and customer service has been our North Star, guiding us through our growth and evolution.</p>
                  <p>Today, we are proud to serve clients across the globe, helping them launch their brands into new orbits of recognition and success.</p>
                </div>
              </div>
              <div className="rounded-lg overflow-hidden shadow-2xl">
                <Image 
                  src={process.env.NEXT_PUBLIC_ENDPOINT + "/download/a.jpg"}
