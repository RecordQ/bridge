      ...
      <main className="flex-1">
        ...
        >
          <div className="container mx-auto text-center relative z-10 px-4">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4">
              <EditableWrapper fieldType="button" translationKey="button_explore_products" styleKeys={{backgroundColor: "button_explore_products_bg", color: "button_explore_products_text", fontSize: "button_explore_products_font_size"}}>
               ...
               <EditableWrapper fieldType="button" translationKey="button_request_quote" styleKeys={{backgroundColor: "button_request_quote_bg", color: "button_request_quote_text", fontSize: "button_request_quote_font_size"}}>
          ...
          <div className="container mx-auto px-4">
            ...
            {topProducts.length > 0 && (
              <div className="text-center mt-12">
                <EditableWrapper fieldType="button" translationKey="button_show_more" styleKeys={{backgroundColor: "button_show_more_bg", color: "button_show_more_text", fontSize: "button_show_more_font_size"}}>
                  <Button asChild size="lg" variant="outline">
                    <Link href="/products">
        ...
        <section className="py-16 md:py-24 bg-transparent">
          <div className="container mx-auto text-center px-4">
              ...
              <EditableWrapper fieldType="button" translationKey="button_contact_us" styleKeys={{backgroundColor: 'button_contact_us_bg', color: 'button_contact_us_text', fontSize: "button_contact_us_font_size"}}>
                <Button asChild size="lg" className="bg-primary text-primary-foreground hover:bg-primary/90">
                    <Link href="/contact">
